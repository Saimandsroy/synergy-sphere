    ...
    <main className="flex flex-col min-h-screen bg-gradient-to-br from-purple-900 via-gray-900 to-black text-white font-sans">
        ...
        <div className="flex gap-6 text-lg font-medium items-center">
          ...
          <Link href="/login" passHref>
            <Button
              variant="outline"
              size="sm"
              className="border-indigo-400 text-indigo-400 hover:bg-indigo-400 hover:text-white transition"
            >
              Login
            </Button>
          </Link>
          <Link href="/auth/register" passHref>
            <Button
              variant="default"
              size="sm"
              className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg transition"
            >
              Register
            </Button>
          </Link>
      ...
      <section className="relative flex flex-col items-center justify-center flex-grow px-6 text-center max-w-5xl mx-auto py-28 select-none">
        ...
        <p className="mt-6 max-w-3xl text-xl text-gray-300 font-light leading-relaxed">
          SynergySphere is the intelligent team collaboration platform that{" "}
          <br />
          centralizes communication, task management, and project insights
          <br />— all designed to help your team achieve peak productivity.
        </p>
          ...
          {[
            {
              ...
              desc: "Instant connection with your team, anywhere.",
            },
            {
              icon: "📈",
              title: "Dynamic Task Tracking",
              desc: "Visualize workload and deadlines effortlessly.",
            },
            {
              icon: "💬",
              title: "Seamless Messaging",
              desc: "Project-specific chat that keeps everyone in sync.",
            },
          ].map(({ icon, title, desc }) => (
            <div
              key={title}
              className="text-left max-w-xs bg-gradient-to-br from-black/30 to-black/10 rounded-3xl p-6 shadow-lg backdrop-blur-md border border-white/10 hover:bg-indigo-900/30 transition"
            >
      ...
      <footer className="bg-gray-900 bg-opacity-90 border-t border-gray-700 text-gray-400 text-sm select-none py-12 px-10 mt-auto">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="flex items-center gap-3 mb-6 md:mb-0">
            ...
            <div>
              ...
              <p className="mt-1 max-w-xs">
                Orchestrate your team workflow, enhance communication, and
                unlock potential.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-16 text-left text-gray-300">
            <div>
              <h4 className="mb-4 font-semibold text-indigo-400">
                Quick Links
              </h4>
